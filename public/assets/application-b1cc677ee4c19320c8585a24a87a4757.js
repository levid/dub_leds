...
;
(function() {
  Cufon.replace('nav.main ul li a', function() {
    return {
  ...
  Cufon.replace('nav.main ul li span', function() {
    return {
      fontFamily: 'Eurostile',
      fontWeight: 400,
      fontStyle: 'normal',
  ...
  Cufon.replace('.text-container h4', function() {
    return {
      fontFamily: 'Eurostile',
      fontWeight: 700,
      fontStyle: 'normal'
  ...
  Cufon.replace('label, input, textarea', function() {
    return {
      fontFamily: 'Eurostile',
      fontWeight: 400,
      fontStyle: 'normal'
  ...
  Cufon.replace('.text-container p', function() {
    return {
      fontFamily: 'Eurostile',
      fontWeight: 400,
      fontStyle: 'normal'
  ...
  Cufon.replace('.copyright', function() {
    return {
      fontFamily: 'Eurostile',
      fontWeight: 400,
      fontStyle: 'normal'
  ...
  Cufon.replace('.text-container ul li', function() {
    return {
      fontFamily: 'Eurostile',
      fontWeight: 400,
      fontStyle: 'normal'
  ...
  Cufon.replace('email-address', function() {
    return {
      fontFamily: 'Eurostile',
      fontWeight: 400,
      fontStyle: 'normal'
...
(function() {
  ...
  window._Dub.Application = jQuery.extend({}, window._Dub.Application, {
    Home: Home
  });
}).call(this);
(function() {
  ...
  RimSelect = (function() {
    __extends(RimSelect, window._Dub);
    ...
    RimSelect.prototype.initRimSelect = function() {
      ...
      return this.circleButtons = $('.rim-reflection .buttons a');
    };
    ...
    RimSelect.prototype.counter = function(direction) {
      if (this.count === 0) {
        return this.count = this.rimCount;
      }
    };
    RimSelect.prototype.decreaseCount = function() {
      if (this.count === 0) {
        return this.count = this.rimCount;
      } else {
        return this.count--;
    ...
    RimSelect.prototype.increaseCount = function() {
      if (this.count === this.rimCount - 1) {
        return this.count = 0;
      } else {
        return this.count++;
      }
      ...
      return this.el.stop().animate({
        ...
        complete: __bind(function() {
          if (this.direction === 'left') {
            this.el.css("left", '-2000px');
          } else if (this.direction === 'right') {
            this.el.css("left", '2000px');
          }
          if (this.method === 'slidePrev') {
            this.increaseCount();
          } else if (this.method === 'slideNext') {
            this.decreaseCount();
          }
          if ($('.rim-reflection .buttons a:eq(' + this.count + ')').attr('class') !== 'active') {
            this.activateButton(this.count);
          }
          this.el.find("li").each(function() {
            return $(this).hide();
          });
          this.el.find("li:eq(" + this.count + ")").show();
    ...
    RimSelect.prototype.initButtons = function() {
      $(".rim-buttons .left a").click(__bind(function(event) {
        event.preventDefault();
        return this.slidePrev();
      }, this));
      $(".rim-buttons .right a").click(__bind(function(event) {
        event.preventDefault();
      ...
      return this.circleButtons.bind('click', __bind(function(event) {
        event.preventDefault();
        this.index = this.circleButtons.index(event.target);
        this.count = this.index;
        if (this.count < this.rimCount / 2) {
          this.slideToLeft(this.count);
        }
        if (this.count >= this.rimCount / 2) {
          this.slideToRight(this.count);
        }
        $('.rim-reflection .buttons a').each(function() {
          $(this).removeClass('active');
          return $(this).css('opacity', '0.6');
        ...
        return $(event.target).css('opacity', '1.0');
      }, this));
    };
    return RimSelect;
  })();
...
(function() {
  ...
  Newsletter = (function() {
    ...
    _Class.prototype.initNewsletter = function() {
