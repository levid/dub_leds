...
class OmniauthCallbacksControllerIntegrationTest < ActionController::IntegrationTest
  FACEBOOK_INFO = {
    "id" => '12345',
    "link" => 'http://facebook.com/iwooten',
    "email" => 'isaac@levid.com',
    "first_name" => 'Isaac',
    "last_name" => 'Wooten',
    "website" => 'http://www.levid.com'
  }
